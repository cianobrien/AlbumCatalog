class LineItemsController < ApplicationController
  ...
  def destroy
    @line_item.destroy
    respond_to do |format|
      format.html { redirect_to @line_item.profile, notice: @line_item.album.name + ' was removed from your profile' }
  ...
  private
    ...
    def line_item_params
      params.require(:line_item).permit(:album_id, :profile_id)
    end
end
